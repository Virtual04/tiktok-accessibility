...
*Magyar leírás. [Read this in English](README.md).*

Böngészőbővítmény, amely a tiktok.com webhelyet teszi használhatóvá képernyőolvasóval (NVDA-ra optimalizálva). Nem külön alkalmazás: a normál TikTok weboldalon fut, a saját fiókoddal, bejelentkezés után. A bejelentések nyelve a böngésző nyelvéhez igazodik: magyar böngészőben magyarul, egyébként angolul szólal meg.
...
2. A lenyíló menüben válaszd a **„Download ZIP”** hivatkozást. A böngésző letölt egy ZIP-fájlt (a neve valami ilyesmi: `tiktok-accessibility-main.zip`).
